...
@section('content')
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a class="btn btn-added" id="btnTambahKondisi"><i data-feather="plus-circle" class="me-2"></i>TAMBAH
                        KONDISI</a>
                </div>
            </div>
            ...
            <div class="card table-list-card">
                <div class="card-body">
                    ...
                    <div class="table-responsive product-list">
                        <table id="kondisiTable" class="table table-hover" style="width: 100%">
    ...
    <!-- md Tambah Kondisi -->
    <div class="modal fade" id="mdTambahKondisi">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="formTambahKondisi" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <!-- md Tambah Jabatan -->
    <div class="modal fade" id="mdEditKondisi">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="page-title">
    ...
    <script src="{{ asset('assets/js/pages/master/kondisi.js') }}"></script>
@endsection
