...
@section('content')
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a class="btn btn-added" id="btnTambahJabatan"><i data-feather="plus-circle" class="me-2"></i>TAMBAH
                        JABATAN</a>
                </div>
            </div>
            ...
            <div class="card table-list-card">
                <div class="card-body">
                    ...
                    <div class="table-responsive product-list">
                        <table id="jabatanTable" class="table table-hover" style="width: 100%">
    ...
    <!-- md Tambah Jabatan -->
    <div class="modal fade" id="mdTambahJabatan">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="formTambahJabatan" method="POST" enctype="multipart/form-data">
    ...
    <!-- md Tambah Jabatan -->
    <div class="modal fade" id="mdEditJabatan">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="page-title">
    ...
    <script src="{{ asset('assets/js/pages/master/jabatan.js') }}"></script>
@endsection
