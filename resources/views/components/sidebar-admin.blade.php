        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu-open">
                    <ul>
                        <li>
                            <a href="dashboard" data-menu-title="POS">
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            ...
                            <li class="submenu submenu-two"><a href="javascript:void(0);"
                                    class="active subdrop"><span>Call</span><span
...
<div class="sidebar horizontal-sidebar">
    <div id="sidebar-menu-3" class="sidebar-menu">
        <ul class="nav">
            <li class="submenu">
                <a href="index.html" class="active subdrop"><i data-feather="grid"></i><span> Main Menu</span>
